...
# bc9d67cc85047b79b30187500483a6212581839d
...
get '/' do
  ...
  #----------extract seniment--------#
    ...
    if search_topic == 'syria' && media == "ALL"
      @articles = @@array_response_syria
    elsif search_topic == 'linkedin' && media == "ALL"
      @articles = @@array_response_linkedin
    elsif search_topic == 'donald trump' && media == "ALL"
      @articles = @@array_response_donald_trump
    elsif search_topic == 'drones' && media == "ALL"
      @articles = @@array_response_drones
    else
